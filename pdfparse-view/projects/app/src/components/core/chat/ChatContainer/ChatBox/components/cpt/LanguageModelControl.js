        ...
        <SelectSection>
          ...
          >
            <div className="font-light flex flex-col">
              ...
              <span className="text-tiny whitespace-normal text-black/50">{models[0].tooltip}</span>
            </div>
          </SelectItem>
        </SelectSection>
        <SelectSection>
      ...
      >
        ...
        {models.map((item) => (
          ...
          >
            <div className="font-light flex flex-col">
              <span>{item.name}</span>
              <span className="text-tiny whitespace-normal text-black/50">{item.tooltip}</span>
            </div>
          </SelectItem>
        ))}
        </SelectSection>
