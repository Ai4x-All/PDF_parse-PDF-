...
const FileReference = dynamic(() => import('../commonProgress/FileReference'));
...
const FileLocal = () => {
  ...
  return (
    <>
      ...
      {activeStep === 1 && <FileReference />}
      {/* {activeStep === 2 && <DataProcess showPreviewChunks />}
      {activeStep === 3 && <Upload />} */}
    </>
  );
};
...
console.log('selectFiles',selectFiles,'fileType', fileType,'aaaaaaaaaaaaaaaaaaaa');
