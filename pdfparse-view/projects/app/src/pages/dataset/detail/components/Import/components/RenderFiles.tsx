                    ...
                    <Flex alignItems={'center'} gap={4}>
                      ...
                      <IconButton
                        ...
                        onClick={() => {
                          ...
                          setPreviewUrl((prevState:any) => prevState.filter((obj:any) => obj.name !== item.sourceName));
                          setpdfResponse((prevState:any) => prevState.filter((obj:any) => obj.name !== item.sourceName))
                          console.log('上传的情况previewUrl',previewUrl,'pdfresponse',pdfresponse);
                          console.log('item的情况',item);
                        }}
                      />
                    </Flex>
                  )}
