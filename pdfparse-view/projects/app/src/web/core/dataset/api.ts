...
/* ======================== dataset ======================= */
export const getDatasets = (data: any) =>
...
export const postCreateDatasetFolder = (data: any) =>
...
export const putDatasetCollectionById = (data: any) =>
...
export const getScrollCollectionList = (data: any) =>
...
/* =============================== data ==================================== */
/* get dataset list */
export const getDatasetDataList = (data: any) =>
...
/* ================ training ==================== */
export const postRebuildEmbedding = (data: any) =>
...
export const getDatasetTrainingQueue = async (datasetId: string): Promise<any> => {
  try {
    const response = await axios.get(`/api/core/dataset/training/getDatasetTrainingQueue`, {
      params: { datasetId } // 使用 `params` 传递查询参数
    });
    console.log('/api/core/dataset/training/getDatasetTrainingQueue:', response.data);
    return response.data;
  } catch (error) {
    console.error('Error fetching dataset training queue:', error);
    throw error; // 抛出错误以便调用时处理
  }
};

export const getPreviewChunks = (data: any) =>
  POST<any>('/core/dataset/file/getPreviewChunks', data);

/* ================== read source ======================== */
export const getCollectionSource = (collectionId: string) =>
  GET<any>('/core/dataset/collection/read', { collectionId });
