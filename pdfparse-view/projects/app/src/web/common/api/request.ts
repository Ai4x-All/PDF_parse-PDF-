...
function responseError(err: any) {
  ...
  if (err?.code in TOKEN_ERROR_CODE) {
    ...
    if (
      !(window.location.pathname === '/chat/share' || window.location.pathname === '/chat/team' || window.location.pathname.startsWith('/chat/customer') || window.location.pathname.startsWith('/customer'))
    ) {
